...
# Model for the questions database
...
# Model for the reportedQuestions database
...
# Model for the comments database
...
# Model for the reported comments database
...
# creating a db model for the users information
...
# a form that will hold the information for people to create an account
...
# a form that will hold the information for people to login  
class loginForm(FlaskForm):
    username = StringField(validators = [InputRequired(), Length(min = 4, max = 20)], render_kw = {"placeholder": "Username"})
    password = PasswordField(validators = [InputRequired(), Length(min = 4, max = 20)], render_kw = {"placeholder": "Password"}) #using passwordField makesit so that when the user enters their shit it's black dots instead of letters
    submit = SubmitField("Login") # Just the button to register and has the word "Login" on it 

# a form that will hold the information for people to delete an account
